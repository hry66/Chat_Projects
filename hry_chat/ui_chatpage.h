...
public:
    ...
    void setupUi(QWidget *ChatPage)
    {
        ...
        horizontalLayout_6 = new QHBoxLayout(title_wid);
        horizontalLayout_6->setObjectName(QString::fromUtf8("horizontalLayout_6"));
        horizontalLayout_6->setContentsMargins(-1, 2, 2, 2);
        ...
        title_lb->setMinimumSize(QSize(0, 0));
        title_lb->setMaximumSize(QSize(16777215, 60));
        ...
        emoji_lb = new ClickedLabel(tool_wid);
        emoji_lb->setObjectName(QString::fromUtf8("emoji_lb"));
    ...
    void retranslateUi(QWidget *ChatPage)
    {
        ...
        title_lb->setText(QApplication::translate("ChatPage", "hry66", nullptr));
